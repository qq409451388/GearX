...
if [ "$LANGUAGE" = "zh" ]; then
    ...
    MSG_START_SERVICE="是否要启动服务? (y/n):"
    MSG_SERVICE_STARTED="服务已启动。"
    MSG_SERVICE_NOT_STARTED="服务未启动。"
    MSG_CHECK_ENV="是否需要检查环境? (y/n):"
    ...
    MSG_START_SERVICE="Do you want to start the service? (y/n):"
    MSG_SERVICE_STARTED="Service has been started."
    MSG_SERVICE_NOT_STARTED="Service not started."
    MSG_CHECK_ENV="Do you want to check the environment? (y/n):"
